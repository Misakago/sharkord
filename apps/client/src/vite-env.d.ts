...
declare global {
  interface Window {
    ...
    __MIKOTORD_STORE__: import('@mikotord/shared').TPluginStore;

    // libs exposed for plugins to use
    __MIKOTORD_EXPOSED_LIBS__: {
    ...
    __MIKOTORD_REACT__: typeof import('react');
    __MIKOTORD_REACT_JSX__: typeof import('react/jsx-runtime');
    __MIKOTORD_REACT_JSX_DEV__: typeof import('react/jsx-dev-runtime');
    __MIKOTORD_REACT_DOM__: typeof import('react-dom');
    __MIKOTORD_REACT_DOM_CLIENT__: typeof import('react-dom/client');
  }
