...
describe('applyEnvOverrides', () => {
  ...
  test('works with the full config overrides map', () => {
    setEnv('MIKOTORD_PORT_TEST', '5000');
    setEnv('MIKOTORD_DEBUG_TEST', 'false');
    setEnv('MIKOTORD_WEBRTC_PORT_TEST', '50000');
    ...
    const overridesMap = {
      'server.port': 'MIKOTORD_PORT_TEST',
      'server.debug': 'MIKOTORD_DEBUG_TEST',
      'mediasoup.webrtcPort': 'MIKOTORD_WEBRTC_PORT_TEST',
      'mediasoup.announcedAddress': 'MIKOTORD_ANNOUNCED_ADDRESS_TEST'
    };
