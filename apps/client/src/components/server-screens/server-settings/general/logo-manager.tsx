...
const LogoManager = memo(({ logo, refetch }: TLogoManagerProps) => {
  ...
  return (
    <Group
      label="Logo"
      description="Square image is recommended. If your image is not perfectly square, the PWA icons will fall back to the default Mikotord icon."
    >
      <ImagePicker
        image={logo}
